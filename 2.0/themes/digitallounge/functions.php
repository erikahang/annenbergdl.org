...
function digitallounge_scripts() {
	wp_enqueue_style( 'digitallounge-style', get_stylesheet_uri(), array(), '2016-08-22-00' );
	

	wp_enqueue_script( 'digitallounge-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20160509', true );
