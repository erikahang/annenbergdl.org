...
function digitallounge_setup() {
	 ...
	 * If you're building a theme based on Digital Lounge, use a find and replace
	 * to change 'digitallounge' to the name of your theme in all the template files
	 */
	load_theme_textdomain( 'digitallounge', get_template_directory() . '/languages' );
	...
	register_nav_menus( array(
		'primary' => __( 'Primary Menu', 'digitallounge' ),
	) );
 ...
 */
function digitallounge_widgets_init() {
	register_sidebar( array(
		'name'          => __( 'Sidebar', 'digitallounge' ),
		'id'            => 'sidebar-1',
		'description'   => '',
...
add_action( 'widgets_init', 'digitallounge_widgets_init' );
...
function digitallounge_scripts() {
	...
	wp_enqueue_script( 'digitallounge-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20130115', true );
